...
REN "dosmag\icon.ico" "DOSmag\icon.old" >NUL 2>&1
COPY "bin\icon.ico" "DOSmag\icon.ico" >NUL 2>&1
...
DEL "DOSmag\icon.ico" >NUL 2>&1
REN "DOSmag\icon.old" "dosmag\icon.ico" >NUL 2>&1
POPD
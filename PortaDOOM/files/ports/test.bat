...
IF %ERRORLEVEL% EQU 1  CALL ..\doom.bat /WAIT /CONSOLE /32 /USE gzdoom-34 /IWAD DOOM.WAD
IF %ERRORLEVEL% EQU 2  CALL ..\doom.bat /WAIT /CONSOLE     /USE gzdoom-34 /IWAD DOOM.WAD
IF %ERRORLEVEL% EQU 3  CALL ..\doom.bat /WAIT /CONSOLE /32 /USE gzdoom-33 /IWAD DOOM.WAD
IF %ERRORLEVEL% EQU 4  CALL ..\doom.bat /WAIT /CONSOLE     /USE gzdoom-33 /IWAD DOOM.WAD
IF %ERRORLEVEL% EQU 5  CALL ..\doom.bat /WAIT /CONSOLE /32 /USE gzdoom-32 /IWAD DOOM.WAD
IF %ERRORLEVEL% EQU 6  CALL ..\doom.bat /WAIT /CONSOLE     /USE gzdoom-32 /IWAD DOOM.WAD
IF %ERRORLEVEL% EQU 7  CALL ..\doom.bat /WAIT /CONSOLE /32 /USE gzdoom-24 /IWAD DOOM.WAD
IF %ERRORLEVEL% EQU 8  CALL ..\doom.bat /WAIT /CONSOLE     /USE gzdoom-24 /IWAD DOOM.WAD
IF %ERRORLEVEL% EQU 9  CALL ..\doom.bat /WAIT /CONSOLE /32 /USE gzdoom-23 /IWAD DOOM.WAD
IF %ERRORLEVEL% EQU 10 CALL ..\doom.bat /WAIT /CONSOLE     /USE gzdoom-23 /IWAD DOOM.WAD
...
IF %ERRORLEVEL% EQU 13 CALL ..\doom.bat /WAIT /CONSOLE /32 /USE gzdoom-21 /IWAD DOOM.WAD
IF %ERRORLEVEL% EQU 14 CALL ..\doom.bat /WAIT /CONSOLE     /USE gzdoom-21 /IWAD DOOM.WAD

IF %ERRORLEVEL% EQU 15 CALL ..\doom.bat /WAIT /CONSOLE     /USE gzdoom-20 /IWAD DOOM.WAD
IF %ERRORLEVEL% EQU 16 CALL ..\doom.bat /WAIT /CONSOLE     /USE gzdoom-19 /IWAD DOOM.WAD
IF %ERRORLEVEL% EQU 17 CALL ..\doom.bat /WAIT /CONSOLE     /USE gzdoom-18 /IWAD DOOM.WAD
IF %ERRORLEVEL% EQU 18 CALL ..\doom.bat /WAIT /CONSOLE     /USE gzdoom-17 /IWAD DOOM.WAD
IF %ERRORLEVEL% EQU 19 CALL ..\doom.bat /WAIT /CONSOLE     /USE gzdoom-16 /IWAD DOOM.WAD
IF %ERRORLEVEL% EQU 20 CALL ..\doom.bat /WAIT /CONSOLE     /USE gzdoom-15 /IWAD DOOM.WAD
IF %ERRORLEVEL% EQU 21 CALL ..\doom.bat /WAIT /CONSOLE     /USE gzdoom-14 /IWAD DOOM.WAD
IF %ERRORLEVEL% EQU 22 CALL ..\doom.bat /WAIT /CONSOLE     /USE gzdoom-13 /IWAD DOOM.WAD
IF %ERRORLEVEL% EQU 23 CALL ..\doom.bat /WAIT /CONSOLE     /USE gzdoom-12 /IWAD DOOM.WAD
IF %ERRORLEVEL% EQU 24 CALL ..\doom.bat /WAIT /CONSOLE     /USE gzdoom-11 /IWAD DOOM.WAD
IF %ERRORLEVEL% EQU 25 CALL ..\doom.bat /WAIT /CONSOLE     /USE gzdoom-10 /IWAD DOOM.WAD
IF %ERRORLEVEL% EQU 26 CALL ..\doom.bat /WAIT /CONSOLE     /USE gzdoom-09 /IWAD DOOM.WAD
